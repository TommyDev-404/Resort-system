...
CREATE TABLE area_revenue (
    ...
    pavillion INT(11) DEFAULT 0,
    mariposa INT(11) DEFAULT 0,
    minicon INT(11) DEFAULT 0,
...
('Pavillion', 101, 'avl', 15000, 15000, 'None'), 
('Mariposa', 101, 'avl', 20000, 20000, 'None'),
('Minicon', 101, 'avl', 10000, 10000, 'None');
